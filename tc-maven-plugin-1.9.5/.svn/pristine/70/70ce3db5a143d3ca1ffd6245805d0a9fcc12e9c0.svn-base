...
public class ManifestMojoTest extends AbstractMojoTestCase {
  ...
  public void testCustomManifestCreation() throws Exception {
    ...
    setVariableValueToObject(manifestMojo, "terracottaRequireVersion", "2.8.0");
    ...
    assertManifest(manifest, "Terracotta-RequireVersion", "2.8.0");
  ...
  public void testGenerateRequiredBundles() throws Exception {
    ...
    dependencies.add(dependency("org.terracotta.some.group", "dependency2", "2.0.0-SNAPSHOT", null));
    dependencies.add(dependency("org.terracotta.some.group", "dependency3", "3.0.0-SNAPSHOT", "test"));
    dependencies.add(dependency("org.terracotta.some.group", "dependency4", "4.0.0-SNAPSHOT", "provided"));
    Manifest manifest = manifestMojo.createManifest();
    assertManifest(manifest, "Require-Bundle",
        "org.terracotta.some.group.dependency2;bundle-version:=\"[2.0.0.SNAPSHOT,2.0.0.SNAPSHOT]\"");

    dependencies.clear();
    dependencies.add(dependency("org.terracotta.some.group", "dependency2", "2.0.0-SNAPSHOT", null));
    dependencies.add(dependency("org.terracotta.some.group", "dependency3", "3.0.0-SNAPSHOT", null));
    manifest = manifestMojo.createManifest();
    assertManifest(
        manifest,
        "Require-Bundle",
        "org.terracotta.some.group.dependency2;bundle-version:=\"[2.0.0.SNAPSHOT,2.0.0.SNAPSHOT]\",org.terracotta.some.group.dependency3;bundle-version:=\"[3.0.0.SNAPSHOT,3.0.0.SNAPSHOT]\"");
  }
  ...
  public class DsoArtifactResolverStub implements DsoArtifactResolver {
    ...
    public File resolveArtifact(String groupId, String artifactId, String version, ArtifactRepository localRepository,
      ...
      try {
        ...
        attributes.putValue("Bundle-Version", MavenToOSGi.projectVersionToBundleVersion(v.getMajorVersion(), v
            .getMinorVersion(), v.getIncrementalVersion(), v.getQualifier()));
