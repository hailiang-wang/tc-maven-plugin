 ...
 * @since 1.2
 * @version $Id: Shell.java 13654 2009-01-28 02:50:02Z hhuynh $
 */
...
//              isDoubleQuotedExecutableEscaped(), false));
          commandLine.add(CommandLineUtils.quote(executable, isSingleQuotedExecutableEscaped(),
              isDoubleQuotedExecutableEscaped(), false));
        } else {
...
//              isDoubleQuotedArgumentEscaped(), false));
          commandLine.add(CommandLineUtils.quote(arguments[i], isSingleQuotedArgumentEscaped(),
              isDoubleQuotedArgumentEscaped(), false));
        } else {
